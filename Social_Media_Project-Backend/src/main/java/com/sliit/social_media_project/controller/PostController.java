...
public class PostController {
    ...
    public ResponseEntity<Post> createPost(@RequestBody Post post, @PathVariable Integer userId) throws Exception {
        ...
        Post creadPost = postService.createNewPost(post, userId);
    ...
    public ResponseEntity<Post> likPostHandler(@PathVariable Integer postId, @PathVariable Integer userId) throws Exception {
